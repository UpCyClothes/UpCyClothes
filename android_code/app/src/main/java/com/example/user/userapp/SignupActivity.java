...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Spinner spinner0= (Spinner) findViewById(R.id.tag0Combo);
        final Spinner spinner1= (Spinner) findViewById(R.id.tag1Combo);

        final ArrayAdapter adapter0 = ArrayAdapter.createFromResource(this, R.array.tagForCustomer, android.R.layout.simple_spinner_dropdown_item);
        final ArrayAdapter adapter1 = ArrayAdapter.createFromResource(this, R.array.tagForCustomer, android.R.layout.simple_spinner_dropdown_item);
        ...
        spinner0.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if(spinner0.getSelectedItemPosition() >= 0){
                    //선택된 항목
                    tag1=adapterView.getItemAtPosition(i).toString();
                    Log.v("알림1",adapterView.getItemAtPosition(i).toString()+ "is selected");
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                tag1=adapterView.getItemAtPosition(0).toString();
            }
        });
        //TAG2
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if(spinner1.getSelectedItemPosition() >= 0){
                    //선택된 항목
                    tag2=adapterView.getItemAtPosition(i).toString();
                    Log.v("알림2",adapterView.getItemAtPosition(i).toString()+ "is selected");
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {

                tag2=adapterView.getItemAtPosition(0).toString();
            }
        });
