...
public class InsertRequest extends StringRequest {
    ...
    public InsertRequest(String productID, String user_ID, String designer, String productName, String count, String price, String productURL, Response.Listener<String> listener){
        ...
        Log.v("insert 정보",productID+user_ID+designer+productName+count+price+productURL);
