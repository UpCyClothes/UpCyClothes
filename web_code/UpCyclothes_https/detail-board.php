...
<script type="text/javascript">
  ...
  function canOrder(quantity){
    if(quantity==0){
      alert("수량이 부족합니다. 구매를 원하시면, 디자이너에게 문의해보세요!");
    }
  }
...
<body>
  ...
  echo "<input class=\"btn btn-success btn-lg\" style=\"margin-right: 10px \" onclick=\"canOrder($quantity)\" type=\"button\" value=\"주문하기\">";
