  ...
  <div class="container">
    ...
    <div class="notice-contents">
        ...
        <?php
         ...
         echo "<tr> </tr>";
         echo "<tr>";
         echo "<td style=\"text-align:center\"><img class=\"img-member\" src=\"../$contents\" ></td>";
         echo "</tr>";
        ?>
        </table>
        <div align="center">
          <input type="button" class="btn btn-success" style="margin-top:10px;"value="목록" onclick=" location.href='./weekly-designer.php';">
        </div>
    </div>
