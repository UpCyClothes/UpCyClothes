      ...
      <div class="col-sm-9">
        ...
        <div class="col-sm-18">
          <div class="well">
            ...
            <?php
                //editNoticeForm.php에서 POST 방식으로 넘어온 값 저장 및 출력
                ...
                $sql = "UPDATE Notice SET noticeID=".$noticeID.",noticeType=".$noticeType.",subject='".$subject."',content='".$content."' WHERE noticeID=".$noticeID."";
                ...
                //헤더를 이용한 리다이렉션 구현
                header("Location: https://upcyclothes.duckdns.org/admin/noticeManaging.php");
