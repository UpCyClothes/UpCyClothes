        ...
        <div class="col-sm-12">
          <div class="well">
            ...
            <table class="table table-hover">
              <thead>
                ...
                <tbody>
                  ...
                  include '../../../../control-admin/user-controller.php';
            ...
            if($currentPage > 1 ) {
              ...
              echo "<a class='btn btn-primary' href ='../admin-user/userManaging.php?currentPage=".($currentPage-1)."'>이전</a>";
              echo "&nbsp; &nbsp; &nbsp; &nbsp;";
            }
            ...
            if($currentPage < $lastPage) {
              ...
              echo "<a class='btn btn-primary' href='../admin-user/userManaging.php?currentPage=".($currentPage+1)."'>다음</a>";
            }
